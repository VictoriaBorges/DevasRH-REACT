...
function Equipe() {
  return (
    <section id="equipe" className="py-32 px-6 bg-[#F8F1EC] text-center">
      <h2 className="text-3xl font-semibold text-[#C58BAA] mb-4 font-serif">
        Nossa Equipe
      </h2>
      ...
      <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto container">
        <CardProfissional
          foto="https://avatars.githubusercontent.com/u/183421243?v=4"
          nome="Juliana Assi"
          resumo="Formada em Big Data e Analytics, Juliana combina sua formação analítica com o olhar de desenvolvedora Full Stack. Atualmente cursa Análise e Desenvolvimento de Sistemas e se destaca pela capacidade de transformar dados e lógica em experiências digitais completas. No bootcamp da Generation, mergulhou em tecnologias como Spring Boot e React, trabalhando em equipe com agilidade e excelência. Sempre dedicada, está em constante busca por inovação."
        />

        <CardProfissional
          foto="https://github.com/daniele-silveira.png"
          nome="Daniele Silveira"
          resumo="Com mais de 20 anos de experiência em tecnologia, Daniele fez uma transição inspiradora da infraestrutura para o desenvolvimento de software. Atuou em empresas de grande porte como parceira da HP e hoje canaliza sua paixão por código em soluções robustas com Java, Spring Boot e React. Além do domínio técnico, traz para os projetos habilidades interpessoais sólidas, desenvolvidas ao longo de uma carreira marcada por resiliência, adaptabilidade e visão estratégica."
        />

        <CardProfissional
          foto="https://github.com/VictoriaBorges.png"
          nome="Victoria Borges"
          resumo="Desenvolvedora Full Stack, formada em Análise e Desenvolvimento de Sistemas. Apaixonada por tecnologia e por atividade física, encontra equilíbrio entre lógica e movimento. Tem uma mente curiosa, espírito colaborativo e determinação de sobra para encarar novos desafios. Está sempre em busca de evoluir como profissional e entregar soluções com propósito e qualidade."
        />
